...
#Calcul de la vitesse d'exécution du code développé dans la séance 1, en particulier la méthode min_power
...
for i in range (1,11):
    ...
    print("La vitesse d'exécution moyenne de la méthode min_power pour le fichier routes.{}.in est de {}.".format(i, average_speed))
